...
| 2026-08-17 | **ADR-0007 gjennomfoert: det roede punktet er lukket** (R218): kapasitetsporten delt i to tak, plassen tas PER SIDE. Roten var at `/jobb` gikk HELT UTENOM porten. Virkning ved 100 brukere: interaktiv median **17 000 ms → 6 ms**, fem ganger saa mange foresproersler betjent. **Men kriteriet jeg selv skrev maalte feil ting** — «p95 under 15 s» maaler maskinens stoerrelse, ikke fordelingen, og riggen doemte paa batchens KOE-tid mot interaktivt ARBEID. Riktig maaling er to kjoeringer: uten batch 33 s, med batch 17 s — ingen forverring, kravet oppfylt. Systemet besto en test riggen ga stroek |
| 2026-08-17 | **ADR-0007 for det roede punktet, og en vakt som fant seks brudd** (R217): §26.3 (reservert kapasitet for interaktive) har na en ADR med maalt problem, fem vurderte alternativer, maalbar Decision Value og exit-strategi — status FORESLAATT, for §20.1 krever at ADR-en foreligger FOER arbeidet begynner. Registerets egen regel «en person, ikke en rolle» var brutt i alle seks eksisterende ADR-er («Prosjekteier NAV dokument-AI»); den eksisterende vakten sjekket at feltet fantes, ikke hva det inneholdt. To av mine egne nye tester duplikerte den gamle vakten og ble fjernet |
| 2026-08-17 | **1000-sidersjobben kjoert** (R215, §26.2): 1000 av 1000 sider, alle 1000 sidemarkoerer, 40,7 min, 0,41 sider/s, null policy-avvik. Sterkeste kontrollen er forholdet, ikke tiden: alt som skal doble seg gjoer det EKSAKT (26 900 rapidocr-regioner, 500 norhand, 200 strekkoder). Riggen meldte foerst «500 av 500» paa en 1000-siders jobb — den var laget for 500 og bare delvis omskrevet |
