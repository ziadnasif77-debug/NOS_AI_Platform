...
| 2026-08-16 | **Den smale fiksen ble bygget — og stroek sin egen port** (R204): laasene delt i tre, jobbarbeideren leser sider i traader med rekkefoelgen bevart, 16 vakttester, og maskineriet virker: 1,38× (5,0 → 8,6 kjerner). Men 2 av 30 sider ble FORTSATT lest annerledes, ogsaa etter at all haandskriftbruk var serialisert. Hypotesen om et kappløp ble dermed MAALT OG FORKASTET. Aarsaken er et TIDSBUDSJETT i norhand-veien: hvor mange haandskriftregioner en side rekker, avhenger av maskinens fart i oeyeblikket. Ingen laas kan rette det — parallellitet ENDRER klokketiden. **Og funnet er stoerre enn fan-out: dette er et R6-brudd som finnes I DAG, uten en eneste traad.** Samme dokument lest paa en travel server gir allerede et annet svar enn paa en rolig; det har ligget der hele tiden, uoppdaget fordi det ikke var reproduserbart. Parallelliteten gjorde det reproduserbart for foerste gang. `OCR_PARALLELLE_SIDER` staar AV, holdt der av en vakttest med begrunnelsen. Retting krever et deterministisk tak i stedet for klokka — en kvalitetsendring som skal maales mot korpuset, ikke antas |
